...
#gpiozero uses BCM numbering (not BOARD)
DIR = 6    # BOARD 31 → BCM 6
STEP = 5   # BOARD 29 → BCM 5
...
class MotorSubscriber(Node):
    ...
    def __init__(self):
        ...
        self.stepper_pub = self.create_publisher(Int32, 'stepperLeft', 10)
    ...
    def controlLoop(self):
        pwm_time, direction = computeSpeed(self.linear_vel, self.angular_vel, "left")
